...
(define-public atomspace-storage
  (let ((commit "5f218d1d15cb25c84150a0a8f3aa6c1f1d301949")
        (revision "5"))
    (package
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "165fhh7skn2wx31j1i8s1q9xrvp0xk6g67mnih1f81r3x0v8iv18"))))
       ...
       (list
        ...
        #~(list "-DCMAKE_BUILD_TYPE=Release"
                ...
                (string-append "-DPYTHON_INSTALL_PREFIX=" #$output
                               ...
                               "/site-packages"))))
      (native-inputs
       (list atomspace cmake cogutil cxxtest gcc-toolchain guile-3.0 pkg-config python-pytest))
      (inputs
       (list atomspace
             cogutil
             gmp
