...
(define-public atomspace-storage
  (let ((commit "4c55b739f8ebe5ba09b1982b8f0f832740887949")
        (revision "7"))
    (package
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "0n5d5mbjg0g623rqnk5ggz4rqsc6v45gm40zwmgqzi4qjlk8wws1"))))
      ...
      (native-inputs
       (list atomspace cmake cogutil cxxtest gcc-toolchain guile-3.0 pkg-config python python-pytest))
      (inputs
       (list atomspace
             cogutil
             gmp
